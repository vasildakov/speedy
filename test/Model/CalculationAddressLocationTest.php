...
/*
 * Note: Be careful with the namespaces, the unit test classes are in "VasilDakov\SpeedyTest"
 * but the main classes are in "VasilDakov\Speedy"
 */

use VasilDakov\Speedy\Model\CalculationAddressLocation; // Note: The class was not imported.
